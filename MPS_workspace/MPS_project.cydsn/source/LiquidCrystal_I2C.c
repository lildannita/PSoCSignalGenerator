...
#if CY_PSOC5
    LCD_I2C_MasterSendStart(addr, 0);
    LCD_I2C_MasterWriteByte(data);
    LCD_I2C_MasterSendStop();
#elif CY_PSOC4
    LCD_I2C_I2CMasterSendStart(addr, 0);
    LCD_I2C_I2CMasterWriteByte(data);
    LCD_I2C_I2CMasterSendStop();
#endif
